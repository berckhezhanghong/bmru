...
#define INRS_VREF_RS_2V				(11000)	 // 2V模块,内阻测量负载电阻,11m欧,分辨率0.1u欧
#define INRS_VREF_RS_12V			(100000)	 // 12V模块,内阻测量负载电阻,100m欧,分辨率0.1u欧
#define INRS_MAX_RS					(255000)	 // 内阻测量最大电阻,255m欧,分辨率1u欧
#define INRS_MIN_RS					(50)	 // 内阻测量最小电阻,255m欧,分辨率1u欧
