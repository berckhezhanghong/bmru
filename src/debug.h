...
#define DEBUG_LEVEL_EMERG			0 // 调试输出等级0,即强制输出等级，用于在代码调试时输出指定的调试信息
#define DEBUG_LEVEL_ALERT			1 // 调试输出等级1,输出紧急信息
#define DEBUG_LEVEL_ERROR			2 // 调试输出等级2,输出错误信息
#define DEBUG_LEVEL_INFO			3 // 调试输出等级3,输出数据
#define DEBUG_LEVEL_DEBUG			4 // 调试输出等级4,输出调试信息
