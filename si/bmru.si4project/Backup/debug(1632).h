...
#define DEBUG_PRINTF                0 // 打印代码编译开关
#define DEBUG_PRINTF_BUFFER_LEN     60  //打印缓冲区长度


#define CONSOLE_PORT_UART1			11
#define CONSOLE_PORT_USBUART		12
#define CONSOLE_PORT_UART2			13

#define CONSOLE_PORT				CONSOLE_PORT_UART2
