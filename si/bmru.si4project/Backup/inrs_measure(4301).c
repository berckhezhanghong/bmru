...
#define FRAME2_ADC_ACQ_NUM  (5)	// 预放电脉冲数
...
sint8 InrsMesurejob(void)
{
	...
	while(1)
	{
		InrsVoltGet(&u16Data1, &u16Data);
		u32Data = (uint32)u16Data;
		u32Data = (u32Data * 3000) / 4096;
		sprintf(DebugBuf, "inrs vv volt: %lu.%luV\r\n", u32Data / 1000, u32Data % 1000);
